...
@section('head')
    <!-- Slick -->
    <link rel="stylesheet" href="{{ url('libs/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ url('libs/slick/slick-theme.css') }}">
                            ...
                            <div class="slick-wrapper">
                                <div class="slider-for mb-3">
                                    <div class="slick-slide-item">
                                        <img src="{{ url('assets/images/products/2.jpg') }}" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                    <div class="slick-slide-item">
                                        <img src="{{ url('assets/images/products/1.jpg') }}" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                    <div class="slick-slide-item">
                                        <img src="{{ url('assets/images/products/3.jpg') }}" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                    <div class="slick-slide-item">
                                        <img src="{{ url('assets/images/products/4.jpg') }}" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                    <div class="slick-slide-item">
                                        <img src="{{ url('assets/images/products/5.jpg') }}" class="w-100 rounded"
                                             alt="image">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="list-group list-group-flush mb-4">
                                        ...
                                        <div class="list-group-item d-flex px-0">
                                            <div class="avatar flex-shrink-0 me-3">
                                                <img src="{{ url('assets/images/user/man_avatar2.jpg') }}" class="rounded-circle" alt="image">
                                            </div>
                                            <div>
...
@section('script')
    ...
    <!-- Examples -->
    <script src="{{ url('dist/js/examples/product-detail.js') }}"></script>
