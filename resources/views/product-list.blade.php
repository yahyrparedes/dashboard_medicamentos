            ...
            <div class="table-responsive">
                <table class="table table-custom table-lg mb-0" id="products">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/1.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Headphone</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/2.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Shoe</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/3.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Digital clock</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/4.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Toy car</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/5.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Sunglasses</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#">
                                <img src="{{ url('assets/images/products/6.jpg') }}" class="rounded" width="40"
                                     alt="...">
                            </a>
                        </td>
                        <td>Cake</td>
...
@section('script')
    ...
    <!-- Examples -->
    <script src="{{ url("dist/js/examples/products.js") }}"></script>
@endsection
